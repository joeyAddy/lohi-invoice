...
const LocationSelectionSheet = forwardRef<
  LocationSelectionSheetRef,
        ...
        <View className="flex-1 bg-white">
          ...
          <View className="p-4 border-gray-200">
            <View className="flex-row items-center justify-between mb-4">
              ...
              <Text className="text-h-5 font-bold">{title}</Text>
              <View style={{ width: 24 }} />
            </View>
...
LocationSelectionSheet.displayName = "LocationSelectionSheet";
